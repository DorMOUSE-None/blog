    ...
    <div className="page-about">
      <div className="about-style">
        <div className="about-head">
          <img className="about-img" src='/static/images/AboutMe.jpeg' alt="avator" />
        ...
        <div className="about-contact">
          ...
          <ul>
            <li>
              <i className="fas fa-link" /> <a href="/">https://www.ffutop.com/</a>
            </li>
          </ul>
          <ul>
            <li>
              <i className="fas fa-at" />{' '}
              <a href="mailto:dormousenone@gmail.com">dormousenone@gmail.com</a>
            </li>
            <li>
